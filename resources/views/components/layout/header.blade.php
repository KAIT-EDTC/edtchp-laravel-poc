<header class="fixed top-0 w-full bg-white text-text px-[4%] py-1.5 flex items-center z-30">
    ...
    <nav class="ml-auto md:hidden">
        <div class="relative mt-3">
            ...
            <label for="sp-menu-toggle" class="relative inline-block w-[30px] h-[22px] align-middle cursor-pointer">
                <span class="absolute top-0 block h-[3px] w-[25px] rounded bg-text before:content-[''] before:absolute before:top-2 before:block before:h-[3px] before:w-[25px] before:rounded before:bg-text after:content-[''] after:absolute after:top-4 after:block after:h-[3px] after:w-[25px] after:rounded after:bg-text"></span>
            </label>
        ...
        <ul class="list-none flex items-center">
            ...
            <li class="ml-3">
                <a href="https://www.instagram.com/kait.edtc/" title="Instagram" rel="noopener noreferrer" target="_blank" aria-label="Instagram"
                   class="inline-flex items-center justify-center w-11 h-11 rounded-full border-2 border-gray-700 text-text hover:text-[#2b5c84] hover:border-white hover:shadow-[inset_0_0_0_22px_#fff] transition-all duration-300">
